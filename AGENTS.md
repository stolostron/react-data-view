...
- Use PatternFly components correctly, following their respective [design guidelines](https://www.patternfly.org/)
- Never use `dangerouslySetInnerHTML` or `innerHTML`
- Demo code in `demo/` is for documentation and testing; demos should accurately represent the component API usage
